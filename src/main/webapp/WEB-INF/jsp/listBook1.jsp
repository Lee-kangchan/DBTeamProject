...
<div id="navigation-block">
    ...
    <div class="container" style="width: 1000px;color: rgb(76,82,75);"><strong style="color: rgb(131,135,143);font-size: 20px;font-family: 'Do Hyeon', sans-serif;">나의 동네</strong><strong style="color: rgb(131,135,143);font-size: 35px;margin-top: -20px;font-family: 'Do Hyeon', sans-serif;">부산시 ㅁㅁ구</strong>
        <div
    ...
    <div class="container" style="margin-top: 3px;border-bottom-style: none;border-bottom-color: rgb(40,167,69);width: 1000px;">
        <div class="row" style="border-bottom-style: solid;border-bottom-color: rgb(40,167,69);padding-bottom: 15px;">
            <div class="col"><strong style="font-family: 'Do Hyeon', sans-serif;">도서 사진</strong></div>
            ...
            <div class="col" style="font-family: 'Do Hyeon', sans-serif;font-size: 20px;"><strong style="font-family: 'Do Hyeon', sans-serif;font-size: 20px;">예치금</strong></div>
        ...
        <div class="row" style="border-bottom-style: none;border-bottom-color: rgb(40,167,69);margin-top: 0px;">
            ...
            <div class="col" style="font-family: 'Do Hyeon', sans-serif;"><strong class="text-center" style="margin-top: 45px;font-family: 'Do Hyeon', sans-serif;">ㅇㅇㅇ원</strong></div>
            <div class="col" style="font-family: 'Do Hyeon', sans-serif;"><button class="btn btn-primary" type="button" style="margin-top: 40px;margin-left: 30px;font-family: 'Do Hyeon', sans-serif;height: 35px;">대여하기</button></div>
        </div>
        <div class="row" style="border-bottom-style: none;border-bottom-color: rgb(40,167,69);margin-top: 0px;">
            <div class="col"><a href="#"></a><img style="height: 120px;"></div>
            <div class="col"><a href="#"><strong class="text-center text-body" style="margin-top: 45px;font-family: 'Do Hyeon', sans-serif;">도서명</strong></a></div>
            ...
            <div class="col" style="font-family: 'Do Hyeon', sans-serif;"><strong class="text-center" style="margin-top: 45px;font-family: 'Do Hyeon', sans-serif;">ㅇㅇㅇ원</strong></div>
            <div class="col" style="font-family: 'Do Hyeon', sans-serif;"><button class="btn btn-primary" type="button" style="margin-top: 40px;margin-left: 30px;font-family: 'Do Hyeon', sans-serif;height: 35px;">예약하기</button></div>
        </div>
        <div class="row" style="border-bottom-style: none;border-bottom-color: rgb(40,167,69);margin-top: 0px;">
            <div class="col"><a href="#"></a><img style="height: 120px;"></div>
            <div class="col"><a href="#"><strong class="text-center text-body" style="margin-top: 45px;font-family: 'Do Hyeon', sans-serif;">도서명</strong></a></div>
