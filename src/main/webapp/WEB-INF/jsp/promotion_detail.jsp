...
<body>
    ...
    <div class="container" style="padding-bottom: 24px;font-family: Do Hyeon, sans-serif;"><strong>프로모션 제목</strong><img style="width: 400px;height: 200px;"><strong>프로모션 기간 : 2020.00.00 ~ 2020.00.00</strong><strong>프로모션 진행여부</strong></div>
    <div class="container" style="width: 1000px;margin-top: 14px;">
        <p style="margin-bottom: 0px;font-size: 21px;font-family: Do Hyeon, sans-serif;">댓글달기<small style="font-family: Do Hyeon, sans-serif;">(00개)</small></p>
        <div class="row">
            <div class="col">
                <form><button class="btn btn-primary border rounded-0" type="button" style="margin-top: 20px;font-family: Do Hyeon, sans-serif;">확인</button><textarea class="border rounded-0 form-control" style="padding-top: 15px;padding-bottom: 15px;border: 3px solid rgb(40,167,69) ;border-right-style: solid;font-family: Do Hyeon, sans-serif;">댓글을 입력하여주세요</textarea></form>
            </div>
        </div>
    </div>
