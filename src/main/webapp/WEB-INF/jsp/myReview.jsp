            ...
            <div class="col" style="width: 70px;border-style: solid;border-color: rgb(40,167,69);">
                <section><strong style="color: rgb(131,135,143);font-size: 30px;font-family: 'Roboto Condensed', sans-serif;padding: 10px;padding-bottom: 18px;margin: 20px;">나의 리뷰</strong>
                    ...
                    <div class="row" style="border-bottom-style: none;border-bottom-color: rgb(40,167,69);margin-top: 0px;">
                        ...
                        <div class="col" style="font-family: 'Do Hyeon', sans-serif;height: 120px;"><strong class="text-center" style="margin-top: 45px;font-family: 'Do Hyeon', sans-serif;"><%=myReview.get(i).get("book_name")%></strong></div>
                        ...
                        <div class="col" style="font-family: 'Do Hyeon', sans-serif;height: 120px;">
                            <div><button class="btn btn-primary btn-sm" type="button" onclick="location.href='/deleteReview/<%=myReview.get(i).get("reivew_seq")%>'" style="margin-top: 61px;margin-left: 40px;font-family: 'Do Hyeon', sans-serif;height: 23px;text-align: right;background: rgb(255,255,255);color: rgb(40,167,69);padding-bottom: 18px;padding-top: -2px;border-width: 3px;border-color: rgb(40,167,69);">삭제하기</button>
                                <button
