...
<body>
    ...
    <div class="container" style="width: 1000px;padding-top: 50px;border-style: none;font-family: Do Hyeon, sans-serif">
        <div class="row">
            <div class="col"><img style="width: 200px;height: 240px;"></div>
        </div>
        <div class="row">
            <div class="col" style="padding-bottom: 32px;"><strong style="font-size: 22px;">도서명</strong><strong>리뷰 수 : 00</strong><strong>평점 :&nbsp;</strong></div>
        </div>
    </div>
    <div class="container" style="width: 1000px;border-style: solid;border-color: rgb(40,167,69);font-family: Do Hyeon, sans-serif">
        <div class="row">
            <div class="col" style="padding-top: 30px;">
                <h1 style="font-size: 30px;font-family: Do Hyeon, sans-serif">리뷰 제목</h1><small style="font-size: 17px;">별점: 00</small><small style="font-size: 17px;padding-left: 0px;margin-left: 17px;">작성자 : 000</small>
                <p style="font-size: 20px;padding-bottom: 30px;border-bottom-style: solid;border-bottom-color: rgb(40,167,69);">리뷰 내용</p>
            </div>
        </div>
        <div class="row">
            <div class="col" style="padding-top: 30px;">
