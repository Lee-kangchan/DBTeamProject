    ...
    <div class="container" style="font-family: 'Do Hyeon', sans-serif;">
        ...
        <!--여기를 고치면 됨 -->
            <div class="col" style="padding-right: 15px;width: 300px;max-width: 300px;">
                ...
                <a href="/updateUser" style="text-decoration:none; color:#212529"><div class="row" style="width: 250px;margin-left: -7px; border-style: solid;border-color: rgb(40,167,69);">
            ...
            <div class="col" style="display:flex; flex-direction:column; justify-content:center;border-style: solid;border-color: rgb(40,167,69);">
                <section>
                    <strong><h2 style="font-family: 'Do Hyeon', sans-serif; margin-top:20px">회원 정보 수정</h2></strong>
                </section>
