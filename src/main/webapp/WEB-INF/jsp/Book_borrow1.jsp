...
<div id="navigation-block">
    ...
    <div class="container" style="width: 1000px;font-family: 'Do Hyeon', sans-serif;">
        <div class="row">
            <div class="col" style="width: 100px;padding-left: 15px;"><img style="width: 150px;height: 250px;"></div>
            ...
            <div class="col">
                <div class="row" style="text-align: right;">
                    <div class="col" style="width: 200px;"><strong style="font-size: 20px;text-align: center;margin: 3px;">Bold</strong></div>
                </div>
                <div class="row" style="text-align: right;font-size: 20px;">
                    <div class="col" style="width: 200px;font-size: 20px;"><strong style="font-size: 20px;text-align: center;margin: 3px;">Bold</strong></div>
                </div>
                <div class="row" style="text-align: right;font-size: 20px;">
                    <div class="col" style="width: 200px;font-size: 20px;"><strong style="font-size: 20px;text-align: center;margin: 3px;">Bold</strong></div>
                </div>
        ...
        <div class="row" style="margin-bottom: 50px;margin-top: 50px;padding-bottom: 15px;">
            <div class="col"><button class="btn btn-primary" type="button" style="padding-right: 80px;padding-left: 80px;padding-top: 10px;padding-bottom: 10px;margin-bottom: 31px;font-size: 20px;text-align: center;margin-top: 0px;">대출 신청</button></div>
        </div>
        ...
        <div class="row" style="text-align: center;border-top-style: none;border-bottom-style: none;">
            <div class="col" style="width: 200px;border-top-style: none;border-top-color: rgb(40,167,69);border-bottom-style: none;border-bottom-color: rgb(40,167,69);">
                <p style="font-size: 18px;">Paragraph</p>
            </div>
        </div>
    </div>
