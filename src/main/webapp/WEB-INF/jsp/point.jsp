    ...
    <div class="container" style="font-family: 'Do Hyeon', sans-serif;">
        ...
        <!--여기를 고치면 됨 -->
            <div class="col" style="padding-right: 15px;width: 300px;max-width: 300px;">
                ...
                <a href="/myPoint" style="text-decoration:none; color:#212529"><div class="row" style="width: 250px;margin-left: -7px; border-style: solid;border-color: rgb(40,167,69);">
            ...
            <div class="col" style="width: 70px;border-style: solid;border-color: rgb(40,167,69);">
                <section>
                <!--여기를 고치면 됨 -->
                <strong style="color: rgb(131,135,143);font-size: 20px;font-family: 'Do Hyeon', sans-serif;">나의 포인트</strong><strong style="color: rgb(131,135,143);font-size: 30px;font-family: 'Do Hyeon', sans-serif;"><%=userInfo.get("customer_point")%>p</strong>
                <!--여기를 고치면 됨 -->
