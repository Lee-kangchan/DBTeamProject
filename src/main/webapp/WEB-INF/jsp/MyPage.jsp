    ...
    <div class="container" style="font-family: 'Do Hyeon', sans-serif;">
        ...
        <div class="row" style="padding-top: 40px;font-family: 'Do Hyeon', sans-serif;">
            ...
            <div class="col" style="width: 70px;border-style: solid;border-color: rgb(40,167,69);">
                ...
                <div class="row" style="border-bottom-style: none;border-bottom-color: rgb(40,167,69);margin-top: 10px;">
                    ...
                    <div class="col" style="margin-top: 20px; font-family: 'Do Hyeon', sans-serif;">
                        <div style="display:flex; flex-direction:column; justify-content:center;">
                            <%if(rental.get(i).get("matching_rental_yn").toString().equals("1")){%> <button class="btn btn-primary btn-sm" type="button" style="margin-top:20px; margin-bottom: 5px; position:relative;font-family: 'Do Hyeon', sans-serif;height: 35px;" onclick="location.href = '/matching/<%= rental.get(i).get("matching_seq")%>/rental/check/0'">확인취소</button>
                            <%}else if(rental.get(i).get("matching_type").toString().equals("대기")){%><button class="btn btn-primary btn-sm" type="button" style="margin-bottom: 5px;position:relative;font-family: 'Do Hyeon', sans-serif;height: 35px;" onclick="location.href = '/matching/<%= rental.get(i).get("matching_seq")%>/rental/check/1'">대여확인</button>
                            <%}else if(rental.get(i).get("matching_type").toString().equals("대여")){%><button class="btn btn-primary btn-sm" type="button" style="position:relative; margin-bottom: 5px; font-family: 'Do Hyeon', sans-serif;height: 35px;" onclick="location.href = '/matching/<%= rental.get(i).get("matching_seq")%>/rental/check/1'">반납확인</button><%}%>
                            ...
                            <%if(rental.get(i).get("matching_type").equals("대기")){%><button class="btn btn-primary btn-sm" type="button" style="position:relative; margin-bottom: 5px; font-family: 'Do Hyeon', sans-serif;height: 35px;" onclick="location.href = '/matching/<%= rental.get(i).get("matching_seq")%>/cancel'">취소하기</button><%}%>
                        </div>
                    </div>
                ...
                <div style="height:10px; border-bottom: 2px solid rgb(40,167,69)"></div>
