        ...
        <div class="row" style="padding-top: 40px;font-family: 'Do Hyeon', sans-serif;">
            ...
            <div class="col" style="width: 70px;border-style: solid;border-color: rgb(40,167,69);">
                <section><strong style="color: rgb(131,135,143);font-size: 20px;font-family: 'Do Hyeon', sans-serif;margin-top: 20px;">나의 대여 등급</strong><strong style="color: rgb(131,135,143);font-size: 35px;margin-top: 4px;font-family: 'Do Hyeon', sans-serif;">OOOO</strong>
                    <div
                        class="row" style="border-bottom-style: solid;border-bottom-color: rgb(40,167,69);padding-bottom: 15px;margin-top: 15px;">
            ...
            <div class="row" style="border-bottom-style: none;border-bottom-color: rgb(40,167,69);margin-top: 0px;">
                ...
                <div class="col" style="font-family: 'Do Hyeon', sans-serif;">
                    <div><button class="btn btn-primary btn-sm" type="button" style="margin-top: 25px;font-family: 'Do Hyeon', sans-serif;height: 35px;">대여확인</button><button class="btn btn-primary btn-sm" type="button" style="margin-top: 60px;margin-left: 50px;font-family: 'Do Hyeon', sans-serif;height: 35px;">신고하기</button></div>
                </div>
