...
<div id="navigation-block">
    ...
    <div class="container" style="width: 1000px;color: rgb(76,82,75);"><strong style="color: rgb(131,135,143);font-size: 20px;font-family: 'Do Hyeon', sans-serif;">나의 대출 등급</strong><strong style="color: rgb(131,135,143);font-size: 35px;margin-top: -20px;font-family: 'Do Hyeon', sans-serif;">OOOO</strong>
        <div
    ...
    <div class="container" style="margin-top: 3px;border-bottom-style: none;border-bottom-color: rgb(40,167,69);width: 1000px;">
        ...
        <div class="row" style="border-bottom-style: none;border-bottom-color: rgb(40,167,69);margin-top: 0px;">
            <div class="col"><a href="#"></a><img style="height: 120px;"></div>
            <div class="col"><a href="#"><strong class="text-center text-body" style="margin-top: 45px;font-family: 'Do Hyeon', sans-serif;">도서명</strong></a></div>
            <div class="col" style="font-family: 'Do Hyeon', sans-serif;"><strong class="text-center" style="margin-top: 45px;font-family: 'Do Hyeon', sans-serif;">대출 중</strong></div>
            <div class="col" style="font-family: 'Do Hyeon', sans-serif;">
                <div><button class="btn btn-primary btn-sm" type="button" style="margin-top: 25px;margin-left: 50px;font-family: 'Do Hyeon', sans-serif;height: 35px;">대출확인</button><button class="btn btn-primary btn-sm" type="button" style="margin-top: 60px;margin-left: 50px;font-family: 'Do Hyeon', sans-serif;height: 35px;">신고하기</button></div>
            </div>
        ...
        <div class="row" style="border-bottom-style: none;border-bottom-color: rgb(40,167,69);margin-top: 0px;">
            <div class="col"><a href="#"></a><img style="height: 120px;"></div>
            <div class="col"><a href="#"><strong class="text-center text-body" style="margin-top: 45px;font-family: 'Do Hyeon', sans-serif;">도서명</strong></a></div>
            <div class="col" style="font-family: 'Do Hyeon', sans-serif;"><strong class="text-center" style="margin-top: 45px;font-family: 'Do Hyeon', sans-serif;">반납 완료</strong></div>
            <div class="col" style="font-family: 'Do Hyeon', sans-serif;">
                <div><button class="btn btn-primary btn-sm" type="button" style="margin-top: 45px;margin-left: 50px;font-family: 'Do Hyeon', sans-serif;height: 35px;">리뷰 작성</button></div>
            </div>
            <div class="col" style="font-family: 'Do Hyeon', sans-serif;"><strong class="text-center" style="margin-top: 40px;font-family: 'Do Hyeon', sans-serif;">2020.00.00<br>~2020.00.00</strong></div>
        </div>
        <div class="row" style="border-bottom-style: none;border-bottom-color: rgb(40,167,69);margin-top: 0px;">
